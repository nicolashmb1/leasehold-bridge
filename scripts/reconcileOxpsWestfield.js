...
const PAGES_DIR =
  process.argv[2] ??
  path.resolve(PACKAGE_ROOT, "..", ".oxps-extract-westfield2", "unzipped", "Documents", "1", "Pages");
...
console.log("WESTFIELD deposit reconciliation");
console.log("LH: westifield2.oxps (06/08/2026)");
